  ...
  return (
    <View style={container}>
      ...
      <View style={controlStyle}>
        <TouchableOpacity style={signInStyle} onPress={() => navigation.navigate("signIn")}>
          <Text style={activeStyle}>SIGN IN</Text>
        </TouchableOpacity>
        <TouchableOpacity style={signUpStyle} onPress={() => navigation.navigate("signUp")}>
...
const signIn = () => {
  ...
  const { row1, iconStyle, titleStyle, container, controlStyle, signUpStyle,
    signInStyle, activeStyle, bigButton, buttonText,
    inputStyle } = styles;
  return (
    <View style={container}>
      <View style={row1}>
